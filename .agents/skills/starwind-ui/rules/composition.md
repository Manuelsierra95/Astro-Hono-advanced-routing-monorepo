...
- Import from `@workspace/ui/components/<component-name>` in this repo unless the project alias or `starwind.config.json` says otherwise.
...
import CardAction from "@workspace/ui/components/card-action";
import CardContent from "@workspace/ui/components/card-content";
import CardDescription from "@workspace/ui/components/card-description";
import CardFooter from "@workspace/ui/components/card-footer";
...
import SelectContent from "@workspace/ui/components/select-content";
import SelectGroup from "@workspace/ui/components/select-group";
import SelectItem from "@workspace/ui/components/select-item";
import SelectSearch from "@workspace/ui/components/select-search";
import SelectTrigger from "@workspace/ui/components/select-trigger";
import SelectValue from "@workspace/ui/components/select-value";
---
...
import TabsContent from "@workspace/ui/components/tabs-content";
import TabsList from "@workspace/ui/components/tabs-list";
import TabsTrigger from "@workspace/ui/components/tabs-trigger";
---
...
import AvatarFallback from "@workspace/ui/components/avatar-fallback";
import AvatarImage from "@workspace/ui/components/avatar-image";
---
